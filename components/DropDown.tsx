    ...
    <View style={styles.horizontalLayout}>
      ...
      >
        <TextInput
          ...
          value={amount}
          ref={(input) => {
            this.dropDownInputs[index] = input
          }}
          returnKeyType="next"
          blurOnSubmit={true}
          onSubmitEditing={() => {
            this.ingredientInputs[index + 1] != undefined
              ? this.ingredientInputs[index + 1].focus()
              : null
          }}
          maxLength={4}
        ...
        />
        <Alata14
          style={[gStyles.alignCenter, styles.marginRight, { flex: 2 }]}
          numberOfLines={1}
          ellipsizeMode="tail"
        >
          {unit}
