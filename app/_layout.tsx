      ...
      <InvitationProvider>
        ...
        >
          <Stack>
            ...
            />
            <Stack.Screen
              name="screens/authentificationScreen"
              options={{
                navigationBarColor: Colors.dark.background,
                headerShown: false,
                presentation: 'fullScreenModal',
            ...
            />
            <Stack.Screen
              name="modals/viewRandomRecipeModal"
              options={{
                navigationBarColor: Colors.dark.mainColorDark,
                headerShown: true,
                presentation: 'fullScreenModal',
            ...
            />
            <Stack.Screen
              name="modals/viewFeedRecipeModal"
              options={{
                navigationBarColor: Colors.dark.mainColorDark,
                presentation: 'fullScreenModal',
                animation: 'fade_from_bottom',
