  ...
  useEffect(() => {
    if (params.recipeID) {
      const fetchRecipe = async () => {
        const fetchedRecipe = await getRecipeByIdForFeed(
            ...
            <View>
              ...
              <View style={gStyles.HorizontalLayout}>
                ...
                <View style={[gStyles.mapHorizontal, gStyles.alignCenter]}>
                  ...
                  >
                    <ArrowDownToLine
                      color={recipeSaved ? Colors.dark.tint : Colors.dark.text}
                      size={24}
                    />
                  </Pressable>
                </View>
              ...
              <View style={[gStyles.card, { gap: 8 }]}>
                ...
                {sortedRatings.map((rating, index) => (
                  ...
                  >
                    ...
                    >
                      <Alata18>{`${rating.username} (${rating.timestamp
                        .toDate()
                        .toLocaleDateString()})`}</Alata18>
                      <View
                        style={{
                          flexDirection: 'row',
                          gap: 3,
                    ...
                    {rating.comment !== '' && (
                      <Alata16>{rating.comment}</Alata16>
                    )}
                  </View>
                ))}
              </View>
