...
import { Alata22, Alata16, Alata14, Alata20 } from '../../../components/StyledText';
  ...
  return (
    ...
    >
      <Pressable onPress={() => setAlertModalVisible(false)} style={styles.background}>
        <View style={[styles.alertCard, {backgroundColor: Colors.dark.background}]}>
          ...
          <View style={styles.horizontal}>
            ...
            <Pressable style={[styles.button, {backgroundColor: Colors.dark.tint}] } onPress={() => {setAlertModalVisible(false), onConfirm()}}>
